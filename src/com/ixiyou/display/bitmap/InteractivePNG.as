package com.ixiyou.display.bitmap
{
	/**
	 * Like magic, transparent parts of a PNG in this MovieClip are ignored during mouse interactions.
	 * 
	 * No special instructions are needed to use this class if the clip's artwork
	 ...
	 * refresh the hit area.
	 * 
	 * 在这影片剪辑里内的PNG 支持透明通道不触犯鼠标事件
	 * 
